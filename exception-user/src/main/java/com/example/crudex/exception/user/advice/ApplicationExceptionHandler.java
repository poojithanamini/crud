package com.example.crudex.exception.user.advice;
...
public class ApplicationExceptionHandler {
    ...
    public Map<String, String> handleSameNameException(SameNameException ex) {
        Map<String, String> errorMap = new HashMap<>();
        errorMap.put("errorMessage", ex.getMessage());
        return errorMap;
    }
    ...
    public Map<String, String> handleDeleteException(DeleteException ex) {
        Map<String, String> errorMap = new HashMap<>();
